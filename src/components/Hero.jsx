        ...
        >
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.98 }}
              className="w-full sm:w-auto rounded-full bg-gradient-to-r from-purple-500 via-indigo-400 to-blue-400 px-5 py-2.5 text-sm font-semibold text-white shadow-lg hover:opacity-95 transition inline-flex items-center justify-center"
            >
              Visit space-H
            </motion.a>
          </div>
